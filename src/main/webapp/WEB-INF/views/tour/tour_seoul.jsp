		...
		<div style="width: 300px; height: 1100px;">
			...
			<div style="width:300px; height: 800px;" id="hotel_filter" >
				<div style="width: 250px; margin-left: 20px;">
					<h3><a href="#" id="tour_seoul_filter_0">전체</a></h3>
					<div style="width: 250px; height: 120px; background-color: #F2F2F2; display: none;"
							id="tour_seoul_filter_0_in">
					</div>
				</div>
				<hr>	
				<div style="width: 250px; margin-left: 20px;">
					<h3><a href="#" id="tour_seoul_filter_1">투어&액티비티</a></h3>
					<div style="width: 250px; height: 120px; background-color: #F2F2F2; display: none;"
				...
				<hr>
				<div style="width: 250px; margin-left: 20px">
					<h3><a href="#" id="tour_seoul_filter_2" >입장권&교통패스</a></h3>
					<div style="width: 250px; height: 120px; background-color: #F2F2F2; display: none;"
				...
				<hr>
				<div style="width: 250px; margin-left: 20px">
					<h3><a href="#" id="tour_seoul_filter_3" >편의서비스</a></h3>
					<div style="width: 250px; height: 120px; background-color: #F2F2F2; display: none;"
